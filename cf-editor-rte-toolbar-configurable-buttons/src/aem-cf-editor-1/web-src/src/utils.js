 ...
 *
 */
async function actionWebInvoke (actionUrl, authToken = {}, orgId, params = {}, options = { method: 'POST' }) {
  const actionHeaders = {
...
export const getContentFragmentConfig = async (token, imsOrg) => {
  return await actionWebInvoke(getActionUrl('getCFModelConfig'),
      token,
      imsOrg
  )
}
