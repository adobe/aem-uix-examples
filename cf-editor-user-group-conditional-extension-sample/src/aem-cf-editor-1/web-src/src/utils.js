...
export const getUserGroupData = async (authToken, aemHost, imsOrg, searchParams) => {
  console.log("ACTION URL", getActionUrl("get-user-groups"), authToken, {
    aemHost: `https://${aemHost}`,
    imsOrg,
    searchParams
  });
  return await actionWebInvoke(getActionUrl("get-user-groups"), authToken, {
    aemHost: `https://${aemHost}`,
    imsOrg,
    searchParams
  });
