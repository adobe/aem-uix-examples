...
function bootstrapInExcShell () {
  ...
  runtime.solution = {
    ...
    title: 'CF Editor Rich Text Editor Toolbar Button',
    shortTitle: 'CF Editor Rich Text Editor Toolbar Button'
  }
  runtime.title = 'CF Editor Rich Text Editor Toolbar Button'
}
