...
const { startWorkflow } = require("../host-service");
...
async function main (params) {
  ...
  try {
    ...
    const requiredParams = ['contentFragmentPath', 'model', 'workflowTitle'];
    ...
    const content = await startWorkflow(
        aemHost,
        token,
        params.contentFragmentPath,
        params.model,
        params.workflowTitle
    );
