...
import CustomActionButtonModal from "./CustomActionButtonModal";
    ...
    <Router>
      <ErrorBoundary onError={onError} FallbackComponent={fallbackComponent}>
        <Routes>
          ...
          />
          <Route
            exact path="content-fragment/:fragmentId/custom-action-button-modal"
            element={<CustomActionButtonModal />}
          />
          <Route
